...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 21, 2018 at 08:12 PM
...
CREATE TABLE IF NOT EXISTS `analysis_master` (
  `analysis_master_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'row_id staff analysis',
  ...
  PRIMARY KEY (`analysis_master_id`),
  KEY `entryid_link` (`entry_id`),
  KEY `related_index` (`class_id`,`section_id`,`criteria_id`,`emp_code`) USING BTREE,
  KEY `employee_master_analysis` (`emp_code`),
  KEY `section_id_analysis_link` (`section_id`),
  KEY `criteria_analysis_link` (`criteria_id`)
...
CREATE TABLE IF NOT EXISTS `class_master` (
  `class_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'class_id by college',
...
CREATE TABLE IF NOT EXISTS `employee_allocation` (
  `employee_allocation_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'row id emloyee_allocation master',
  `class_id` int(11) NOT NULL COMMENT 'class id from class master',
  `emp_code` int(11) NOT NULL,
  `created_at` varchar(255) DEFAULT NULL,
  `updated_at` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`employee_allocation_id`),
  KEY `class_emplyoee_allocation` (`class_id`),
  KEY `employee_employee_allocation` (`emp_code`)
...
CREATE TABLE IF NOT EXISTS `employee_master` (
  `emp_code` int(11) NOT NULL AUTO_INCREMENT COMMENT 'employee unique id from college',
...
(2, 'rushi', '9898989887', 'rushi2@gmail.com', 1, 'emp_img_2', '1530886520', '1532203000'),
...
CREATE TABLE IF NOT EXISTS `option_master` (
  ...
  KEY `criteria_option_link` (`criteria_id`)
...
CREATE TABLE IF NOT EXISTS `remarks_master` (
  `remark_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'row id for remarks_master',
  `entry_id` int(11) NOT NULL COMMENT 'entry_id from entry_record',
  `section_id` int(11) NOT NULL COMMENT 'section_id from section_master',
...
CREATE TABLE IF NOT EXISTS `section_master` (
  `section_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'seciotn_mster id',
...
(1, 'admin@feedback.com', 1, '96e79218965eb72c92a549dd5a330112', 1, 'user_img_1', NULL, '1532200357');
