...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 11, 2018 at 12:43 PM
...
CREATE TABLE IF NOT EXISTS `criteria_master` (
  ...
  `updated_at` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='Criteria Master Table';

--
-- Dumping data for table `criteria_master`
--

INSERT INTO `criteria_master` (`id`, `point_name`, `created_at`, `updated_at`) VALUES
(1, 'Subject Knowlege', '1528720444', '1528720444'),
(2, 'preparedness', '1528720456', '1528720468'),
(3, 'regularity', '1528720477', '1528720477'),
(4, 'Fluency in English', '1528720487', '1528720491'),
(5, 'Starts class in time', '1528720502', '1528720502'),
(6, 'Relationship with Students', '1528720516', '1528720523'),
(7, 'Class Disicpline', '1528720535', '1528720535'),
(8, 'Periodic Class Test', '1528720548', '1528720548');
