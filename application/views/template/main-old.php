...
<div id="pageContent">
    <div class="container-fluid offset-0">
        <div class="row indent-col-none custom-layout">
            <div class="col-sm-6">
                <a href="listing-left-column.html" class="promo-box zoom-in design-08">
                    <img src="images/custom/promo-img-36.jpg" alt="">
                    <div class="description">
                        <div class="block-table">
                            <div class="block-table-cell">
                                <p>Get Ready for Website Creation Unlike</p>
                                <div class="title">Anything You Have Ever Seen</div>
            ...
            <div class="col-sm-6">
                <a href="listing-left-column.html" class="promo-box zoom-in design-08">
                    <img src="images/custom/promo-img-37.jpg" alt="">
                    <div class="description">
                        <div class="block-table">
                            <div class="block-table-cell">
        ...
        <div class="row indent-col-none custom-layout">
            <div class="col-sm-6">
                <div class="row indent-col-none">
                    <div class="col-extra-400 col-xs-6 col-md-6">
                        <a href="listing-left-column.html" class="promo-box zoom-in point-left design-14">
                            <img src="images/custom/promo-img-38.jpg" alt="">
                            <div class="description point-left">
                                <div class="block-table">
                                    <div class="block-table-cell">
                                        <div class="title color-defaulttext2">Women’s</div>
                    ...
                    <div class="col-extra-400 col-xs-6 col-md-6">
                        <a href="listing-left-column.html" class="promo-box zoom-in design-14">
                            <img src="images/custom/promo-img-39.jpg" alt="">
                            <div class="description point-left">
                                <div class="block-table">
                                    <div class="block-table-cell">
                                        <div class="title color-defaulttext2">Men’s</div>
                                        <span class="btn btn-lg btn-underline color-base">SHOP NOW!</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <a href="listing-left-column.html" class="promo-box zoom-in design-09">
                        <img src="images/custom/promo-img-41.jpg" alt="">
                        <div class="description point-left">
                            <div class="block-table">
                                <div class="block-table-cell">
                                    <p class="text-xl">Grow your Business</p>
                                    <div class="title">With MyShop</div>
                                    <span class="btn btn-red btn-lg">SHOP NOW!</span>
                                </div>
                            </div>
                        </div>
                    </a>
            ...
            <div class="col-sm-6">
                <div class="row">
                    <a href="listing-left-column.html" class="promo-box zoom-in design-06">
                        <img src="images/custom/promo-img-40.jpg" alt="">
                        <div class="description point-left">
                            <div class="block-table">
                                <div class="block-table-cell">
                                    <p>MyShop is Dedicated </p>
                                    <div class="title">Ecommerce Template with<br>  Increadible Features</div>
                                    <span class="btn btn-lg btn-border color-white">SHOP NOW!</span>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="row indent-col-none">
                    <div class="col-extra-400 col-xs-6 col-md-6">
                        <a href="listing-left-column.html" class="promo-box zoom-in design-14">
                            <img src="images/custom/promo-img-42.jpg" alt="">
                            <div class="description point-left">
                                <div class="block-table">
                                    <div class="block-table-cell">
                    ...
                    <div class="col-extra-400 col-xs-6 col-md-6">
                        <a href="listing-left-column.html" class="promo-box zoom-in design-14">
                            <img src="images/custom/promo-img-43.jpg" alt="">
                            <div class="description point-left">
                                <div class="block-table">
                                    <div class="block-table-cell">
        ...
        <div class="row">
            <div class="menu-content">
                <ul>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_01.png" alt="Shirts">
                            <span class="title">Shirts</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_02.png" alt="Sweaters">
                            <span class="title">Sweaters</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_03.png" alt="Sweatshirts">
                            <span class="title">Sweatshirts</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_04.png" alt="Denim">
                            <span class="title">Denim</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_05.png" alt="T-Shirts">
                            <span class="title">T-Shirts</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_06.png" alt="Jackets">
                            <span class="title">Jackets</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_07.png" alt="Outerwear">
                            <span class="title">Outerwear</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_08.png" alt="Pants">
                            <span class="title">Pants</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_09.png" alt="Skirts">
                            <span class="title">Skirts</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_10.png" alt="Dresses">
                            <span class="title">Dresses</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_11.png" alt="Shorts">
                            <span class="title">Shorts</span>
                        </a>
                    </li>
                    <li>
                        <a href="listing-left-column.html">
                            <img src="images/custom/clothes_img_12.png" alt="Lingerie">
                ...
                <div>
                    <div class="product">
                        <div class="product_inside">
                            ...
                            <h2 class="title">
                                <a href="product.html">Nike Reversable Across Body Bag</a>
                            </h2>
                ...
                <div>
                    <div class="product">
                        <div class="product_inside">
                            ...
                            <h2 class="title">
                                <a href="product.html">ASOS Poplin Shirt In Long Sleeve</a>
                            </h2>
                            <div class="price view">
                                $15
                            </div>
                ...
                <div>
                    <div class="product">
                        <div class="product_inside">
                            ...
                            <h2 class="title">
                                <a href="product.html">Lazy Oaf High Neck Leotard With Cat Stripe Print</a>
                            </h2>
                            <div class="price view">
                                $35
                            </div>
                ...
                <div>
                    <div class="product">
                        <div class="product_inside">
                            <div class="image-box">
                                <a href="product.html">
                                    <img src="images/product/product-24.jpg" alt="">
                                </a>
                                <a href="#" data-toggle="modal" data-target="#ModalquickView" class="quick-view">
										<span>
										<span class="icon icon-visibility"></span>QUICK VIEW
    ...
    <div class="container">
        <h1 class="block-title">SPECIALS</h1>
        <div class="row">
            <div class="carousel-products-1 carouselTab slick-arrow-top products-mobile-arrow">
                <div>
                    <div class="product">
                ...
                <div>
                    <div class="product">
                        <div class="product_inside">
                            ...
                            <h2 class="title">
                                <a href="product.html">Vans Nintendo Game Over Trucker Hat</a>
                            </h2>
                            <div class="price">
                ...
                <div>
                    <div class="product">
                        <div class="product_inside">
                            ...
                            <h2 class="title">
                                <a href="product.html">Diesel T-Shirt T-Clar Winged Triangle Print</a>
                            </h2>
                            <div class="price view">
                                $15
                            </div>
