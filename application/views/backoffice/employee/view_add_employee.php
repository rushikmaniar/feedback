...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#employee_frm").validate({
            ...
            rules:
                {
                    'employee_frm_emp_code': {required: true},
                    'employee_frm_emp_name': {required: true},
                    'employee_frm_emp_email': {required: true, email: true},
                    'employee_frm_emp_phone': {regex: "^[6-9]\\d{9}$"}
                },

            messages:
                {
                    'employee_frm_emp_code': {required: "This field is required."},
                    'employee_frm_emp_name': {required: "This field is required."},
                    'employee_frm_emp_email': {required: "This field is required.", email: "Please enter valid email."},
                    'employee_frm_emp_phone': {regex: "Please Enter valid mobile number"}
                }
        });
        /*************************************
         Add Edit User End
